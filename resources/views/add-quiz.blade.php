     ...
     @if(!session('quizDetails'))
        ...
        @else
          ...
          <form action="" method="get" class="space-y-4">
            ...
            <button type="submit" class="w-full bg-blue-500 rounded-xl px-4 py-2">Add More</button>
            <button type="submit" class="w-full bg-green-500 rounded-xl px-4 py-2">Add and Submit</button>
